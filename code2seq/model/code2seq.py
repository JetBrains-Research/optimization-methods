...
class Code2Seq(LightningModule):
    ...
    def validation_step(self, batch: PathContextBatch, batch_idx: int, test: bool = False) -> Dict:  # type: ignore
        # [seq length; batch size; vocab size]
        ...
        if test:
            self.outputs.append(prediction.detach().cpu())
    ...
    def test_epoch_end(self, outputs: List[Dict]):
        ...
        torch.save(self.outputs, f"outputs/{self._config.hyper_parameters.optimizer}_test_outputs.pkl")
