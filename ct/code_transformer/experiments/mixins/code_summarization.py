...
from code_transformer.modeling.constants import NUM_SUB_TOKENS_METHOD_NAME, NUM_SUB_TOKENS, MAX_NUM_TOKENS
...
class CTCodeSummarizationMixin(ExperimentSetup, ABC):
    ...
    def _init_data(self, language, use_validation=False, mini_dataset=False,
                   ...
                   dataset_imbalance=None, mask_all_tokens=False, infinite_loading=True, max_num_tokens=MAX_NUM_TOKENS, docstrings=False):
    ...
    def _create_validation_dataset(self, data_location, language, use_only_ast, use_no_punctuation, token_distances,
                                   ...
                                   filter_language, dataset_imbalance, mask_all_tokens, max_num_tokens):
