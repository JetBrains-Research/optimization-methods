...
def computeChrF(fpRef, fpHyp, nworder=2, ncorder=6, beta=2., return_sentence_level_scores=True):
    ...
    averageTotalF = 0.0
    if return_sentence_level_scores:
        sentence_scores = []
    else:
    ...
    return totalF, averageTotalF, totalPrec, totalRec, sentence_scores